      ...
      <div>
        <div className="PrivacyApp">
          ...
          <div className="privacycontent">
            ...
            <p className="pclass">Last updated: February 03, 2023</p>
            <p className="pclass">
            ...
            <h3 className="h3class">Interpretation and Definitions</h3>
            ...
            <h4>Definitions</h4>
            <p className="pclass">For the purposes of this Privacy Policy:</p>
            <ul>
              ...
              <li className="liclass">
                ...
                “Our” in this Agreement) refers to INDILABS.AI PTE. LTD., 111
                SOMERSET ROAD #08-10A 111 SOMERSET SINGAPORE (238164).
              </li>
              <li className="liclass">
              ...
              <li className="liclass">Country refers to: Singapore</li>
              <li className="liclass">
              ...
              <li className="liclass">Service refers to the Website.</li>
              <li className="liclass">
              ...
              <li className="liclass">
                Website refers to Indilabs, accessible from
                https://www.indilabs.ai
              </li>
              <li className="liclass">
            ...
            <ul>
              <li className="liclass">
                ...
                <p className="cookie-section pclass">Type: Session Cookies</p>
            ...
            <ul>
              ...
              <li className="liclass">Protect against legal liability</li>
            </ul>
            ...
            <h3 className="h3class">Children’s Privacy</h3>
            <p className="pclass">
            ...
            <h3 className="h3class">Links to Other Websites</h3>
            <p className="pclass">
            ...
            <h3 className="h3class">Changes to this Privacy Policy</h3>
            <p className="pclass">
